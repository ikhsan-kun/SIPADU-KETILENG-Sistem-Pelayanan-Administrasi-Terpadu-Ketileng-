...
<body>
    ...
    <div class="title-section text-center">
        <h4 class="uppercase underline font-bold">SURAT KETERANGAN TIDAK MAMPU</h4>
    ...
    <div class="content">
        ...
        <p>Berdasarkan keterangan yang ada pada kami dan keadaan yang sebenarnya, orang tersebut di atas benar-benar warga Desa Ketileng yang berdomisili di alamat tersebut, dan yang bersangkutan termasuk dalam keluarga yang <strong>TIDAK MAMPU (Keluarga Prasejahtera)</strong>.</p>
