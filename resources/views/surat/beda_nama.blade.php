...
<body>
    ...
    <div class="title-section text-center">
        <h4 class="uppercase underline font-bold">SURAT KETERANGAN BEDA NAMA</h4>
    ...
    <div class="content">
        ...
        <table>
            <tr><td class="w-30">Nama Resmi (KTP)</td><td class="w-2">:</td><td><strong>{{ $penduduk->nama }}</strong></td></tr>
        ...
        <p>Menyatakan dengan sebenar-benarnya bahwa terdapat perbedaan penulisan nama warga tersebut pada dokumen administrasi penting lainnya sebagai berikut:</p>
        
        <p class="text-center font-bold">"{{ $pengajuan->keperluan }}"</p>

        <p>Kepala Desa menerangkan bahwa nama-nama tersebut di atas adalah merujuk pada **satu orang yang sama** yang merupakan warga Desa Ketileng, Kecamatan Kramat, Kabupaten Tegal.</p>
