...
<body>
    ...
    <div class="title-section text-center">
        <h4 class="uppercase underline font-bold">SURAT KETERANGAN DOMISILI</h4>
    ...
    <div class="content">
        ...
        <p>Orang tersebut di atas adalah benar-benar warga yang berdomisili / bertempat tinggal di Desa Ketileng, Kecamatan Kramat, Kabupaten Tegal.</p>
