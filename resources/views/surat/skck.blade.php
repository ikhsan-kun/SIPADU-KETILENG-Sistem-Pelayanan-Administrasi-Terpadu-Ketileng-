...
<body>
    ...
    <div class="title-section text-center">
        <h4 class="uppercase underline font-bold">SURAT PENGANTAR KELAKUAN BAIK (SKCK)</h4>
    ...
    <div class="content">
        ...
        <table>
            ...
            <tr><td>Status Perkawinan</td><td>:</td><td>{{ $penduduk->status_perkawinan }}</td></tr>
            <tr><td>Pekerjaan</td><td>:</td><td>{{ $penduduk->pekerjaan }}</td></tr>
            <tr><td>Alamat</td><td>:</td><td>{{ $penduduk->alamat_lengkap }}</td></tr>
        </table>

        <p>Sepanjang pengetahuan kami, nama tersebut di atas berkelakuan baik, belum pernah tersangkut tindak pidana, dan tidak sedang dalam status tahanan yang berwajib.</p>
        
        <p>Surat pengantar ini diberikan sebagai syarat untuk <strong>Mengurus SKCK (Surat Keterangan Catatan Kepolisian)</strong> dengan keperluan:</p>
