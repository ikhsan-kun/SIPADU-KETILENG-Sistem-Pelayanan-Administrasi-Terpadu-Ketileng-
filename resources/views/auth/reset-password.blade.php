        ...
        <div class="w-full max-w-md space-y-8 relative z-10">
            ...
            <div class="space-y-3">
                <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 border border-blue-100 shadow-sm mb-1">
                    ...
                    <p class="text-[10px] font-bold text-blue-600 uppercase tracking-widest">Langkah Terakhir Pemulihan</p>
                </div>
                <h2 class="text-3xl lg:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-slate-900 to-blue-800 tracking-tight">Kata Sandi Baru</h2>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative" style="position: relative;">
                        ...
                        <button type="button" id="toggle-password-btn" class="flex items-center text-slate-400 hover:text-slate-600 focus:outline-none" style="position: absolute; right: 16px; top: 0; bottom: 0; z-index: 10; cursor: pointer;">
                ...
                <div>
                    ...
                    <div class="relative" style="position: relative;">
                        ...
                        <button type="button" id="toggle-password-confirm-btn" class="flex items-center text-slate-400 hover:text-slate-600 focus:outline-none" style="position: absolute; right: 16px; top: 0; bottom: 0; z-index: 10; cursor: pointer;">
